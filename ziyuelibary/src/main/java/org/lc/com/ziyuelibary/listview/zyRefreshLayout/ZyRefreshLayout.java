package org.lc.com.ziyuelibary.listview.zyRefreshLayout;
...
import org.lc.com.ziyuelibary.R;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.api.DefaultRefreshFooterCreater;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.api.DefaultRefreshHeaderCreater;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.api.RefreshContent;
...
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.api.ScrollBoundaryDecider;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.constant.DimensionStatus;
...
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.header.BezierRadarHeader;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.header.FalsifyHeader;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.impl.RefreshContentWrapper;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.impl.RefreshFooterWrapper;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.impl.RefreshHeaderWrapper;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.listener.OnLoadmoreListener;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.listener.OnMultiPurposeListener;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.listener.OnRefreshListener;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.listener.OnRefreshLoadmoreListener;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.utils.DelayedRunable;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.utils.DensityUtil;
import org.lc.com.ziyuelibary.listview.zyRefreshLayout.utils.ViscousFluidInterpolator;
...
import static org.lc.com.ziyuelibary.listview.zyRefreshLayout.utils.DensityUtil.dp2px;
...
public class ZyRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected boolean mManualNestedScrolling = false;//9
    //</editor-fold>
    ...
    public ZyRefreshLayout(Context context) {
        super(context);
        this.initView(context, null);
    }

    public ZyRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public ZyRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public ZyRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ZyRefreshLayout);

        ViewCompat.setNestedScrollingEnabled(this, ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.ZyRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.ZyRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.ZyRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.ZyRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.ZyRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.ZyRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadmore = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableLoadmore, mEnableLoadmore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.ZyRefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.ZyRefreshLayout_srlFooterHeight, density.dip2px(60));
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.ZyRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.ZyRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadmore = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableAutoLoadmore, mEnableAutoLoadmore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableLoadmoreWhenContentNotFull = ta.getBoolean(R.styleable.ZyRefreshLayout_srlEnableLoadmoreWhenContentNotFull, mEnableLoadmoreWhenContentNotFull);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.ZyRefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.ZyRefreshLayout_srlFixedFooterViewId, View.NO_ID);

        mManualLoadmore = ta.hasValue(R.styleable.ZyRefreshLayout_srlEnableLoadmore);
        mManualNestedScrolling = ta.hasValue(R.styleable.ZyRefreshLayout_srlEnableNestedScrolling);
        mHeaderHeightStatus = ta.hasValue(R.styleable.ZyRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.ZyRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
        ...
        int accentColor = ta.getColor(R.styleable.ZyRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.ZyRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
...
//        }
    ...
    protected void setStateLoding() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshFooter != null) {
                    mRefreshFooter.onStartAnimator(ZyRefreshLayout.this, mFooterHeight, mFooterExtendHeight);
                }
                if (mLoadmoreListener != null) {
                    mLoadmoreListener.onLoadmore(ZyRefreshLayout.this);
                }
                if (mOnMultiPurposeListener != null) {
                    mOnMultiPurposeListener.onLoadmore(ZyRefreshLayout.this);
    ...
    protected void setStateRefresing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(ZyRefreshLayout.this);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(ZyRefreshLayout.this, mHeaderHeight, mHeaderExtendHeight);
                }
                if (mOnMultiPurposeListener != null) {
                    mOnMultiPurposeListener.onRefresh(ZyRefreshLayout.this);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ZyRefreshLayout_Layout);
            backgroundColor = ta.getColor(R.styleable.ZyRefreshLayout_Layout_layout_srlBackgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.ZyRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.ZyRefreshLayout_Layout_layout_srlSpinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
...
//        }
    ...
    @Override
    public ZyRefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(dp2px(heightDp));
    }

    @Override
    public ZyRefreshLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public ZyRefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(dp2px(heightDp));
    }

    @Override
    public ZyRefreshLayout setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public ZyRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public ZyRefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public ZyRefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public ZyRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public ZyRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public ZyRefreshLayout setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public ZyRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableLoadmore(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public ZyRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableAutoLoadmore(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setEnableLoadmoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public ZyRefreshLayout setRefreshHeader(RefreshHeader header) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public ZyRefreshLayout setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
                removeView(mRefreshHeader.getView());
            }
     ...
     */
    @Override
    public ZyRefreshLayout setRefreshFooter(RefreshFooter footer) {
        if (footer != null) {
            if (mRefreshFooter != null) {
     ...
     */
    @Override
    public ZyRefreshLayout setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
                removeView(mRefreshFooter.getView());
            }
     ...
     */
    @Override
    public ZyRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public ZyRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public ZyRefreshLayout setOnLoadmoreListener(OnLoadmoreListener listener) {
     ...
     */
    @Override
    public ZyRefreshLayout setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadmoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
        return this;
     ...
     */
    @Override
    public ZyRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public ZyRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
     ...
     */
    @Override
    public ZyRefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public ZyRefreshLayout setLoadmoreFinished(boolean finished) {
     ...
     */
    @Override
    public ZyRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public ZyRefreshLayout finishLoadmore() {
     ...
     */
    @Override
    public ZyRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public ZyRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
     ...
     */
    @Override
    public ZyRefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Refreshing) {
                    if (mRefreshHeader != null) {
                        int startDelay = mRefreshHeader.onFinish(ZyRefreshLayout.this, success);
                        notifyStateChanged(RefreshState.RefreshFinish);
                        if (mOnMultiPurposeListener != null) {
     ...
     */
    @Override
    public ZyRefreshLayout finishLoadmore(int delayed) {
     ...
     */
    @Override
    public ZyRefreshLayout finishLoadmore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public ZyRefreshLayout finishLoadmore(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mKernel != null && mRefreshContent != null) {
                        int startDelay = mRefreshFooter.onFinish(ZyRefreshLayout.this, success);
                        if (startDelay == Integer.MAX_VALUE) {
                            return;
                        }
                        notifyStateChanged(RefreshState.LoadFinish);
    ...
    protected class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return ZyRefreshLayout.this;
        }

        @NonNull
        @Override
        public RefreshContent getRefreshContent() {
            return ZyRefreshLayout.this.mRefreshContent;
        }

        //<editor-fold desc="状态更改 state changes">
        public RefreshKernel setStatePullUpToLoad() {
            ZyRefreshLayout.this.setStatePullUpToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToLoad() {
            ZyRefreshLayout.this.setStateReleaseToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToRefresh() {
            ZyRefreshLayout.this.setStateReleaseToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownToRefresh() {
            ZyRefreshLayout.this.setStatePullDownToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownCanceled() {
            ZyRefreshLayout.this.setStatePullDownCanceled();
            return this;
        }

        public RefreshKernel setStatePullUpCanceled() {
            ZyRefreshLayout.this.setStatePullUpCanceled();
            return this;
        }

        public RefreshKernel setStateLoding() {
            ZyRefreshLayout.this.setStateLoding();
            return this;
        }

        public RefreshKernel setStateRefresing() {
            ZyRefreshLayout.this.setStateRefresing();
            return this;
        }

        @Override
        public RefreshKernel setStateLodingFinish() {
            ZyRefreshLayout.this.setStateLodingFinish();
            return this;
        }

        @Override
        public RefreshKernel setStateRefresingFinish() {
            ZyRefreshLayout.this.setStateRefresingFinish();
            return this;
        }

        public RefreshKernel resetStatus() {
            ZyRefreshLayout.this.resetStatus();
            return this;
        }
        //</editor-fold>
...
//        }
        ...
        public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            ZyRefreshLayout.this.moveSpinner(spinner, isAnimator);
            return this;
        }

        public RefreshKernel animSpinner(int endSpinner) {
            ZyRefreshLayout.this.animSpinner(endSpinner);
            return this;
        }
